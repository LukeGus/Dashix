                    ...
                    <Card className="w-full">
                        <CardContent className="p-8 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-base leading-relaxed">
                                    We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" className="text-primary underline hover:no-underline">Privacy Policy Generator</a>.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <section className="space-y-4">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="space-y-3 list-disc pl-6">
                                            ...
                                            <li className="text-base leading-relaxed">
                                                <strong>Website</strong> refers to Dashix, accessible from <a href="http://www.dashix.dev" rel="external nofollow noopener" target="_blank" className="text-primary underline hover:no-underline">http://www.dashix.dev</a>
                                            </li>
                                            <li className="text-base leading-relaxed">
                                ...
                                <section className="space-y-6">
                                    <h2 className="text-2xl font-semibold tracking-tight">Collecting and Using Your Personal Data</h2>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <ul className="space-y-2 list-disc pl-6">
                                                <li className="text-base leading-relaxed">Usage Data</li>
                                            </ul>
                                        </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <ul className="space-y-3 list-disc pl-6">
                                            <li className="text-base leading-relaxed"><strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
                                            <li className="text-base leading-relaxed"><strong>For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
                                            <li className="text-base leading-relaxed"><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
                                            <li className="text-base leading-relaxed"><strong>With business partners:</strong> We may share Your information with Our business partners to offer You certain products, services or promotions.</li>
                                            <li className="text-base leading-relaxed"><strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</li>
                                            <li className="text-base leading-relaxed"><strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-xl font-medium">Delete Your Personal Data</h3>
                                        <p className="text-base leading-relaxed">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <ul className="space-y-2 list-disc pl-6">
                                                <li className="text-base leading-relaxed">Comply with a legal obligation</li>
                                                <li className="text-base leading-relaxed">Protect and defend the rights or property of the Company</li>
                                                <li className="text-base leading-relaxed">Prevent or investigate possible wrongdoing in connection with the Service</li>
                                                <li className="text-base leading-relaxed">Protect the personal safety of Users of the Service or the public</li>
                                                <li className="text-base leading-relaxed">Protect against legal liability</li>
                                            </ul>
                                        </div>
                                    </div>

...
export function SidebarUI({}: {}) {
  ...
  const feedbackForm = useForm({
    defaultValues: { title: "", feedback: "", honey: "" },
  });
    ...
    axios
      ...
      .catch((err) => {
        if (
          ...
          setFeedbackError(
            "You have made too many feedback requests. Please try again later."
          );
        } else {
  ...
  return (
    <>
      <SidebarHeader>
        <div className="flex flex-col items-center w-full">
          <div className="flex items-center justify-center w-full py-2 -mt-1">
            <span className="font-bold text-lg tracking-tight">Dashix</span>
          </div>
      ...
      <SidebarFooter>
        <div className="flex items-center justify-center w-full py-0 gap-2">
          <a
              ...
              {feedbackError && (
                ...
                >
                  ...
                  <div className="flex flex-col justify-center w-full">
                    <AlertTitle className="font-semibold text-foreground leading-tight m-0 p-0">
                      Error
                    </AlertTitle>
                    <AlertDescription
